...
a = wordcloud2(top10cloud )
imgpng <- readPNG("/Users/wshmac/Documents/GitHub/testgit/PJ1 image/Rplot10.png")
...
```{r}
a1 = wordcloud2(top10, color = ifelse(top10[, 3] == 1, 'red', 'skyblue'), size = 0.5, shape = 'diamond')
imgpng <- readPNG("/Users/wshmac/Documents/GitHub/testgit/PJ1 image/Rplot07.png")
r <- nrow(imgpng)/ncol(imgpng) 
plot(c(0,1),c(0,r),type = "n",xlab = "",ylab = "",asp=1)
rasterImage(imgpng,0,0,1,r)
```
...
```{r}
a2 = wordcloud2(top10, color = ifelse(top10[, 3] == 2, 'orange', 'skyblue'), size = 0.5, shape = 'diamond')
imgpng <- readPNG("/Users/wshmac/Documents/GitHub/testgit/PJ1 image/Rplot02.png")
r <- nrow(imgpng)/ncol(imgpng) 
plot(c(0,1),c(0,r),type = "n",xlab = "",ylab = "",asp=1)
rasterImage(imgpng,0,0,1,r)
```
...
```{r}
a3 = wordcloud2(top10, color = ifelse(top10[, 3] == 3, 'purple', 'skyblue'), size = 0.5, shape = 'diamond')
imgpng <- readPNG("/Users/wshmac/Documents/GitHub/testgit/PJ1 image/Rplot03.png")
r <- nrow(imgpng)/ncol(imgpng) 
plot(c(0,1),c(0,r),type = "n",xlab = "",ylab = "",asp=1)
rasterImage(imgpng,0,0,1,r)
```
